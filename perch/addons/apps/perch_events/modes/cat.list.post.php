    ...
    <table>
        <thead>
            <tr>
                ...
                <th><?php echo $Lang->get('Events'); ?></th>
                <th><?php echo $Lang->get('Future events'); ?></th>
                <th class="action"></th>
            </tr>
        </thead>
        <tbody>
...
?>
            <tr>
                ...
                <td><?php echo $HTML->encode($Category->categoryEventCount())?></td> 
                <td><?php echo $HTML->encode($Category->categoryFutureEventCount())?></td>  
